  ...
  const projectsData = [
    {
      ...
      category: 'Operations',
      featured: true,
      description: 'Interactive analytics platform evaluating market concentration, charging capacity distribution across Germany, and global EV policy readiness across UN member states.',
    ...
    },
    {
      ...
      category: 'Sales',
      featured: false,
      description: 'Time-series sales analysis evaluating peak periods, order volumes, best-selling products, and seasonal demand patterns.',
    ...
    },
    {
      ...
      category: 'Finance',
      featured: false,
      description: 'Comprehensive banking dashboard monitoring loan performance, assessing debt-to-income (DTI) ratios, and segmenting risk profiles.',
    ...
    },
    {
      ...
      category: 'HR',
      featured: false,
      description: 'End-to-end workforce analytics platform tracking key attrition drivers, demographic splits, and compensation distributions across 10,000+ employees.',
    ...
    },
    {
      ...
      category: 'AI & ML',
      featured: false,
      description: 'Convolutional Neural Network (CNN) integrated with OpenCV for real-time facial detection, input preprocessing, and demographic estimation.',
    ...
    <section id="projects" className="py-24 w-full bg-zinc-50 dark:bg-zinc-950 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="space-y-8">
          ...
          {/* Featured Large Layout (If matching current filter) */}
          {featuredProject && (
