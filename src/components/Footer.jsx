    ...
    <footer className="py-12 border-t border-zinc-200 dark:border-zinc-900/60 relative z-10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="p-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:border-zinc-300 dark:hover:border-zinc-700 transition-all"
            >
              {link.icon}
            </a>
          ))}
        ...
        <div className="text-center space-y-1">
          <p className="font-semibold text-sm text-zinc-500 dark:text-zinc-600">
            &copy; 2026 Ali Asghar. All rights reserved.
          </p>
          <p className="text-zinc-400 dark:text-zinc-700 text-xs font-medium">
